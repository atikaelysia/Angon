					...
					<div class="account-list-outer">
						...
						<div class="checkout-content">
							...
							<form method="post" action="<?php echo base_url();?>ecomerce/konfirmasi/konfirmasi_penerimaan" class="form-horizontal">
							    ...
							    <div class="controls">
							      <input type="text" id="inputFirstName" name="id" placeholder="198292900999">
							    </div>
							    ...
							    <div class="controls">
							    	<textarea id="inputFirstName" name="id" placeholder="Barang belum diterima"></textarea>
							    </div>
								</div><!--end control-group-->


								<div class="control-group success">
								<label class="control-label" for="inputFirstName">Upload Gambar
								</label>
									    <div class="controls">
